        ...
        <div className="w-full h-150 bg-gray-900 mb-4">
            ...
            <div className="flex flex-nowrap w-full h-auto overflow-x-auto scrollbar-custom overflow-y-hidden pb-6 mt-20 scrollbar-hide">
                <div className="flex gap-3 space-x-4 px-4 mt-5">
                    ...
                    <Cer src={meriemImg} name="Bouarroudj Meriem" caption="At IGEnergy, success is built on unity and collaboration. Differences in opinions and perspectives are natural, but progress comes when we set aside conflicts, focus on our shared goals, and work together with respect and determination.🤙"/>
